...
#define enc28j60_select() GPIO_ResetBits(GPIOA, GPIO_Pin_15)
#define enc28j60_release() GPIO_SetBits(GPIOA, GPIO_Pin_15)
...
void enc28j60_init(uint8_t *macadr)
{
  ...
  GPIO_PinAFConfig(GPIOC, GPIO_PinSource12 , GPIO_AF_SPI3);
		...
		// SS
	GPIO_InitTypeDef GPIO_Init_SS;
	GPIO_Init_SS.GPIO_Pin = GPIO_Pin_15;
	GPIO_Init_SS.GPIO_Mode = GPIO_Mode_OUT;
	GPIO_Init_SS.GPIO_OType = GPIO_OType_PP;
	GPIO_Init_SS.GPIO_Speed = GPIO_Speed_50MHz;

	GPIO_Init(GPIOA, &GPIO_Init_SS);
